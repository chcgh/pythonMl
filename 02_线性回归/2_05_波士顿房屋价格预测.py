...
np.set_printoptions(suppress=True)  # 打印禁用科学计数法
...
# 划分训练集和测试集
xTarin, xTest, yTarin, yTest = train_test_split(X, Y, test_size=0.33, random_state=10)
...
print(linear.coef_)  # 参数
print(linear.intercept_)  # 截距项
